function curved_wheel_transform(self,offsetFromCenter,_fake1,_fake2)
	...
	local paddingY = THEME:GetMetric("MusicWheel", "CenterPaddingY")*clamp(offsetFromCenter, -1, 1)
	self:x( (1-math.cos(offsetFromCenter/math.pi))*curveX )
	self:y( (offsetFromCenter*scale(math.abs(offsetFromCenter), 0,numItems/2, spacingY,spacingY*math.sin(0.675))) +paddingY )
