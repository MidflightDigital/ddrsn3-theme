...
return Def.ActorFrame{
	InitCommand=cmd(x,SCREEN_RIGHT-80;y,SCREEN_CENTER_Y+52;draworder,99);
	LoadActor("_item")..{
		OnCommand=cmd(addx,758;sleep,0.264;decelerate,0.264;addx,-780;decelerate,0.1;addx,22);
		GainFocusCommand=function(s) MESSAGEMAN:Broadcast("PadsDouble") s:glowshift():effectcolor1(color("1,1,1,0.2")):effectcolor2(color("0,0,0,0")):effectperiod(0.5) end;
