...
return Def.ActorFrame{
	InitCommand=cmd(x,SCREEN_RIGHT-280;y,SCREEN_CENTER_Y+52;draworder,99);
	LoadActor("_item")..{
	...
	LoadActor("../_Style/_Style highlight")..{
		...
		GainFocusCommand=cmd(visible,true;glowshift;blend,Blend.Add;;effectcolor1,color("0,1,0,1");effectcolor2,color("0,1,0,0");effectperiod,0.2);
