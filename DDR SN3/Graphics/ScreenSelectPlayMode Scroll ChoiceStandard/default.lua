local t = Def.ActorFrame{
	...
	LoadActor("icon")..{
		...
		GainFocusCommand=cmd(diffuse,color("0,0,0,1");linear,0.2;diffuse,color("1,1,1,1"));
		LoseFocusCommand=cmd(diffuse,color("0,0,0,1");linear,0.2;diffuse,color("0.5,0.5,0.5,1"));
		OffCommand=cmd(sleep,0.116;linear,0.066;zoomy,0;diffusealpha,0);
	};
};
