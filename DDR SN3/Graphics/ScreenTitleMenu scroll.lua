...
return Def.ActorFrame {
	Def.ActorFrame{
		LoadActor("title cursor2")..{
			...
			GainFocusCommand=cmd(finishtweening;cropright,1;addx,10;linear,0.125;diffusealpha,0.5;cropright,0;addx,-10);
			LoseFocusCommand=cmd(finishtweening;linear,0.125;addx,10;diffusealpha,0;addx,-10);
