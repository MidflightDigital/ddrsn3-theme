...
if FILEMAN:DoesFileExist(THEME:GetCurrentThemeDirectory() .. "BGAnimations/ScreenGameplay toasty/char.lua") and GAMESTATE:IsPlayerEnabled("PlayerNumber_P1") then
t[#t+1] = Def.ActorFrame {
	LoadActor(charP1);
};
elseif FILEMAN:DoesFileExist(THEME:GetCurrentThemeDirectory() .. "BGAnimations/ScreenGameplay toasty/char.lua") and GAMESTATE:IsPlayerEnabled("PlayerNumber_P2") then
t[#t+1] = Def.ActorFrame {
	LoadActor(charP2);
};
end
