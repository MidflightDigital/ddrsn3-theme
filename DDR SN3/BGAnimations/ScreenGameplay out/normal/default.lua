...
local clearMessageNormal = LoadActor("cleared")..{
	...
	OnCommand=cmd(diffusealpha,0;sleep,1.3;zoomy,0;zoomx,4;linear,0.198;diffusealpha,1;zoomy,1;zoomx,1;sleep,2.604;linear,0.132;zoomy,0;zoomx,4;diffusealpha,0);
};
