...
t[#t+1] = Def.ActorFrame{
	...
	Def.BitmapText{
		...
		OnCommand=cmd(diffusealpha,0;sleep,11;linear,1;diffusealpha,1;sleep,1;diffusealpha,0);
	};
	--Left Square
	Def.Quad{
		InitCommand=cmd(setsize,15,15;xy,SCREEN_CENTER_X-140,SCREEN_CENTER_Y;diffuse,color("0,0,0,1"));
		OnCommand=cmd(zoom,0;sleep,11;linear,1;diffusealpha,0.75;zoom,1;rotationz,405;linear,1;addx,-20;sleep,0.25;diffusealpha,0);
	};
	--Right Square
	Def.Quad{
		InitCommand=cmd(setsize,15,15;xy,SCREEN_CENTER_X+140,SCREEN_CENTER_Y;diffuse,color("0,0,0,1"));
	...
	LoadActor(THEME:GetPathB("","ScreenLogo background/ddrsn_logo"))..{
		...
		OnCommand=cmd(diffusealpha,0;sleep,13;diffusealpha,1)
	};
	LoadActor(THEME:GetPathB("","_shared/logo flash"))..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-8;zoom,0.9);
		OnCommand=cmd(diffusealpha,0;sleep,13;linear,0.1;diffusealpha,1;sleep,0.1;linear,0.1;diffusealpha,0;queuecommand,"Anim");
	...
	Def.ActorFrame{
		InitCommand=cmd(xy,SCREEN_LEFT+120,SCREEN_TOP+120;zoom,1.5;diffuse,color("1,1,1,1"));
		OnCommand=cmd(zoom,0;sleep,3.2;decelerate,0.75;zoom,1.5);
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/ball"));
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/shine"))..{
			InitCommand=cmd(diffuse,color("0.5,0.5,0.5,0.5"));
		};
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/inside circle rim"))..{
			InitCommand=cmd(spin;effectmagnitude,0,0,5);
		};
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/outer rim"))..{
			InitCommand=cmd(spin;effectmagnitude,5,10,20);
		};
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/middle rim"))..{
			InitCommand=cmd(spin;effectmagnitude,-35,20,-50);
		};
		LoadActor(THEME:GetPathB("","ScreenWithMenuElements background/inner rim"))..{
...
t[#t+1] = Def.ActorFrame{
	Def.Quad{
		...
		OnCommand=cmd(cropright,1;sleep,13;decelerate,0.2;cropright,0);
	};
	Def.BitmapText{
		Font="_handelgothic bt 20px",
		InitCommand=cmd(diffuse,color("#18ff00");xy,SCREEN_LEFT+180,SCREEN_BOTTOM-80;zoom,0.75;settext,"PRESS START BUTTON");
		OnCommand=cmd(cropleft,0;cropright,1;sleep,13;decelerate,0.2;cropright,0;queuecommand,"Anim2");
...
t[#t+1] = Def.ActorFrame{
	LoadActor(THEME:GetPathB("","ScreenLogo background/sponsor"))..{
		...
		OnCommand=cmd(cropbottom,1;sleep,13;linear,0.2;cropbottom,0);
	};
