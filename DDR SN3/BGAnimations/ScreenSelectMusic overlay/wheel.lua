...
local t = Def.ActorFrame{
	...
	Texture="WheelEffec.png",
		InitCommand=function(self)
			self:hibernate(1.25):draworder(101):x(SCREEN_RIGHT-238):y(SCREEN_CENTER_Y-16.5):visible(false)
		end,
		OnCommand=function(self)
			self:sleep(0.264):visible(true)
		end,
		OffCommand=function(self)
			self:sleep(0.033):accelerate(0.33):addx(380)
		end,
		RandomCommand=function(self)
			self:croptop(1):linear(0.25):cropleft(0):linear(0.25):cropleft(1)
		end
	};
};
