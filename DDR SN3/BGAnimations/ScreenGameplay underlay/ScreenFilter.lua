...
if numPlayers == 1 then
	...
	t[#t+1] = Def.Quad{
		...
		InitCommand=cmd(x,pos;CenterY;zoomto,filterWidth*1.2,SCREEN_HEIGHT;diffusecolor,filterColor;diffusealpha,filterAlphas[player];fadeleft,1/32;faderight,1/32);
	};
else
